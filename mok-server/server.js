...
if (should_reroute) {
  try {
    ...
    console.error(
      '\x1b[33m%s\x1b[0m',
      'Failed to connect to development backend. Trying to initialize local server',
    );
    should_reroute = false;
  }
}
