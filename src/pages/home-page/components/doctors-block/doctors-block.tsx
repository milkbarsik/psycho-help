// ВНИМАНИЕ! Данный блок на данный момент нигде не используется!
// Закомментированно, чтобы не вызывать ошибки при сборке
...
//   const [params] = useState<Pagination>({ pageSize: 15, pageNo: 1 });
...
//     queryFn: () => serviceApi.getTherapists(),
